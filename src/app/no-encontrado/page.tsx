...
import lockAnimation from '@/assets/animations/lock.json'
    ...
    <DashboardLayout>
      <div className="max-w-md mx-auto mt-24 px-6 py-12 text-center bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-3xl shadow-xl">
        <div className="flex justify-center mb-5">
          <Lottie animationData={lockAnimation} loop autoplay style={{ width: 160, height: 160 }} />
        </div>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
          Esta sección es exclusiva para miembros con una suscripción{' '}
