...
export default function PremiumAreaPage() {
  ...
  // 🔐 Redirige si no tiene acceso premium
  useEffect(() => {
  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto mt-10 px-4">
        ...
        <div className="rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 p-6 shadow-xl space-y-5">
          <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed">
            🎉 <strong>¡Bienvenido!</strong> Esta sección es exclusiva para usuarios con membresía activa. Aquí encontrarás:
          </p>

          <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 pl-2">
            <li>📘 Acceso a documentos académicos premium</li>
            <li>📬 Asesoría personalizada con tutores verificados</li>
            <li>📥 Descargas ilimitadas sin tiempos de espera</li>
